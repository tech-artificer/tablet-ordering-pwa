...
<template>
    <section class="flex flex-col items-center justify-center">
        <div class="flex items-center justify-center gap-10 mt-3 mb-3">
            ...
            <!-- Guest Count Display -->
            <div class="flex h-28 w-28 items-center justify-center rounded-full border-4 border-primary bg-transparent text-white text-6xl font-bold shadow-lg shadow-primary/20">
                {{ guestCount }}
            </div>
