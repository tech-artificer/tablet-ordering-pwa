...
<template>
    ...
    >
        ...
        <div class="px-5 pt-5 pb-3 border-b border-white/[0.07]">
            <!-- Label -->
            <p class="text-white/30 text-[10px] font-black uppercase tracking-[0.2em] mb-3">
                Order Summary
            </p>
            ...
            <div v-if="isRefillMode" class="mb-3 bg-success/15 rounded-xl px-3 py-2.5 border border-success/25">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <p class="font-bold text-success text-sm leading-none">
                            Refill Order
                        </p>
                        <p class="text-[10px] text-success/70 mt-0.5">
                            Unlimited items only
                        </p>
                    </div>
                </div>
            </div>
            <!-- Guests row — read-only; count is locked once set on the guest counter screen -->
                ...
                <div v-if="orderedItems.length > 0">
                    ...
                    <div class="space-y-2">
                        <div
                            ...
                            :key="item.id || item.menu_id || item.menu_item_id"
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-white font-medium text-xs truncate">
                                    {{ item.name || item.menu?.name || item.menu_item?.name || item.menu_name || 'Menu Item' }}
                                </p>
                    ...
                    >
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p class="text-white/40 text-[10px] mt-0.5 leading-none">
                                    Tap cancel to stop
                                </p>
                            </div>
                        </div>
