<template>
    <div
        ...
        :class="[
            ...
            index === 1 ? 'bg-primary' : 'bg-gray-600',
        ]"
        @click="handlePackageSelect(pkg.id, pkg.items, pkg.name, pkg.price)"
    >
        <!-- Badge -->
        <div class="flex justify-center mb-4">
            <div class="bg-black px-4 py-1 rounded-full">
        ...
        <div class="text-center mb-4">
            <h3 :class="`text-2xl font-normal ${pkg.textColor} leading-tight`">
                {{ pkg.name }}
            </h3>
            <p :class="`text-2xl font-normal ${pkg.textColor}`">
                &#x20B1; {{ pkg.price }}
            </p>
        </div>
        ...
        <div
            ...
            class="absolute top-4 right-4 w-8 h-8 bg-orange-600 rounded-full flex items-center justify-center shadow-lg"
        >
