      ...
      <el-col :span="17" class="flex-auto w-full h-full" style="overflow: hidden;">
        ...
        <div class="flex flex-col gap-2 overflow-x-auto scrollbar-hide ml-1 py-2">
          <div class="flex gap-2 mb-2">
            <button v-for="(cat, idx) in categories" :key="idx" @click="activeCategory = cat"
              class="px-4 py-1 rounded-full font-kanit whitespace-nowrap transition" :class="activeCategory === cat
          ...
          <h2 class="text-l font-raleway font-extrabold ml-2">{{ activeCategory }}</h2>
        </div>
