...
// definePageMeta({    
//     layout: 'printLayout',
//       middleware: false, // Disable all middleware for this page
// })
onMounted(() => {
...
//     try {
//         //android intent
//         const testPrint = 'Test Data \n Dine'
//         const intent = `intent://${testPrint}/#Intent;scheme=rawbt;package=ru.a402d.rawbtprinter;end`
...
// const testPrint = () => {
//     window.location.href = `rawbt://print?text=Hello`
// }
...
//         const encoded = 'Dine In Test print';
//         const intent = `intent:${encoded}#Intent;scheme=${encoded};package=ru.a402d.rawbtprinter;end`
//         window.location.href = intent
...
<template>
    <div class="bg-gray-900 text-white h-full w-full min-h-screen min-w-screen">
        ...
        <div class="w-full p-2">
             <div class="w-full">
                <button v-show="!isConnected" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 w-full" @click="testPrint()">Test Print</button>
            </div>
            <div class="w-full">
